...
<!-- <p ><h2 style="color: red">donghochinhhang.net</h2></p> -->
				...
				<td>
					<a href="#" ><img src="../images/shop.png" style="width: 50px;height: 50px" alt=""> <b class="caret"></b></a>
				</td>
				<td >
					<a href="qldh.php"><img src="../images/avatar.png" style="width: 50px;height: 50px"></a>
				</td>
...
<div class="slide">
   ...
   <script>
	...
	<div class="menu" style="padding-top: 70px;">
		<nav>
		<ul id="menu-bar">
	...
	<div style="text-align: center;" >
		<ul class="class6">
			<li><a href="sanpham.php"><img src="../images/dh5.PNG" />
	    			</br>
	    			<h3>Đồng hồ Gucci</h3>
	    			500.000đ</a></li>
			<li style="padding-left: 20px;"><a href="sanpham.php"><img src="../images/dh6.PNG" />
	    			</br>
	    			<h3>ĐỒng hồ Longines</h3>
	    		      1.000.000đ</a></li>
			<li style="padding-left: 20px;"><a href="sanpham.php"><img src="../images/dh7.PNG" />
	    			</br>
	    			<h3>Đồng hồ Omega</h3>
	    		     1.000.000đ</a></li>
			<li style="padding-left: 20px;"><a href="sanpham.php"><img src="../images/dh8.PNG" />
	    			</br>
	    			<h3>Đồng hồ Quartz</h3>
	    		     999.000đ</a></li>
		</ul>
	</div>
	<div style="text-align: center;" >
	...
	<div style="text-align: center;" >
		<ul class="class6">
			<li><a href="sanpham.html"><img src="../images/dh5.PNG" />
	    			</br>
	    			<h3>Đồng hồ Gucci</h3>
	    			500.000đ</a></li>
			<li style="padding-left: 20px;"><a href="sanpham.php"><img src="../images/dh6.PNG" />
	...
	<div style="text-align: center;" >
		<ul class="class6">
			<li><a href=""><img src="../images/dh5.PNG" />
	    			</br>
	    			<h3>Đồng hồ Gucci</h3>
	    			500.000đ</a></li>
			<li style="padding-left: 20px;"><a href="sanpham.html"><img src="../images/dh6.PNG" />
	    			</br>
	    			<h3>ĐỒng hồ Longines</h3>
	    		      900.000đ</a></li>
			<li style="padding-left: 20px;"><a href="sanpham.html"><img src="../images/dh7.PNG" />
	    			</br>
	    			<h3>Đồng hồ Omega</h3>
	    		     700.000đ</a></li>
			<li style="padding-left: 20px;"><a href="sanpham.html"><img src="../images/dh8.PNG" />
	    			</br>
	    			<h3>Đồng hồ Quartz</h3>
	    		     699.000đ</a></li>
		</ul>
